...
import { WTTCustomBuffService } from "./Services/CustomBuffService";
...
import { CustomWeaponPresets } from "./Services/CustomWeaponPresets";
...
implements IpreSptLoadMod, IPostDBLoadMod
{
    ...
    private modName = "WTTRockasCornerStore";
    private config;

    //#region CustomBosses
    private WTTCustomBuffService: WTTCustomBuffService = new WTTCustomBuffService();
    ...
    private displayCreditBanner(): void 
    {
        ...
        this.Instance.logger.log(
            `[${this.modName}] Developers:           RockaHorse,                          Framework: GrooveyPenguinX`, 
            LogTextColor.GREEN
        );
        this.Instance.logger.log(
            `[${this.modName}] ------------------------------------------------------------------------`,
